...
namespace PersonsInfo
{
    public class Person
    {
        ...
        { 
            ...
            private set 
            {
                if (value != null && value.Length < 3) throw new ArgumentException("First name cannot contain fewer than 3 symbols!");
                firstName = value; 
            } 
        }
        ...
        { 
            ...
            private set 
            {
                if (value != null && value.Length < 3) throw new ArgumentException("Last name cannot contain fewer than 3 symbols!");
                lastName = value; 
            } 
        }
        public int Age 
        ...
        {
            if (Age < 30) Salary += Salary * percentage / 200;
